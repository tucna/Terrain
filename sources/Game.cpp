...
void Game::Initialize(HWND window, int width, int height)
{
  ...
  m_world = std::make_unique<World>(m_d3dDevice.Get(), m_d3dContext.Get());
...
void Game::Render()
{
  ...
  m_shaderManager->ApplyColorShader(m_d3dContext.Get(), m_world->GetIndexCount(), DirectX::XMMatrixIdentity(), m_camera->GetViewMatrix(), m_camera->GetProjectionMatrix());
